...
type Estado = "inicial" | "cargando" | "resultado";
  ...
  return (
    <div>
      ...
      <div className="mx-auto max-w-7xl space-y-8 px-4 py-10 sm:px-6 lg:px-8">
        ...
        <Card className="card-soft border-border/70">
          <CardContent className="space-y-5">
            ...
            <div className="flex flex-wrap gap-3">
              <Button onClick={analizar} size="lg" disabled={estado === "cargando"}>
              ...
              <Button
                variant="outline"
                size="lg"
                onClick={() => setValidacion(validarSmiles(smiles))}
              >
                Validar estructura
              </Button>
        ...
        {estado === "cargando" ? (
          <LoadingAnalysis onFinish={() => setEstado("resultado")} />
        ) : null}

        {estado === "resultado" ? <ResultadoPrediccion smiles={smiles} /> : null}
      </div>
    </div>
  );
}
