...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "MolPredict EGFR — Predicción QSAR de inhibidores" },
      {
        name: "description",
        content:
          "Plataforma experimental de análisis QSAR para estimar la actividad inhibitoria de compuestos frente al receptor EGFR.",
      },
      { name: "author", content: "MolPredict EGFR" },
      { property: "og:title", content: "MolPredict EGFR — Predicción QSAR de inhibidores" },
      {
        property: "og:description",
        content:
          "Plataforma experimental de análisis QSAR para estimar la actividad inhibitoria frente a EGFR.",
      },
